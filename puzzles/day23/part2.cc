...
constexpr State kInitialState{
    .hallway = {},
    .room_a = {Cell::kB, Cell::kD, Cell::kD, Cell::kC},
    .room_b = {Cell::kA, Cell::kC, Cell::kB, Cell::kD},
    .room_c = {Cell::kB, Cell::kB, Cell::kA, Cell::kD},
    .room_d = {Cell::kC, Cell::kA, Cell::kC, Cell::kA}};
